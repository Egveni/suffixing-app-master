...
public class CopyMode {
    private static final Logger logger = Logger.getLogger(CopyMode.class.getName());

    public void fileRenamingInCopyMode() throws IOException {
        ...
        for (String file : files) {
            ...
            if (suffix.equalsIgnoreCase("")) {
                ...
                String filePath1 = file.substring(0, index);
                String newFolderName = "newFiles/";
                String filePath2 = file.substring(index + 6);
                File renamedFiles = new File(filePath1 + newFolderName + suffix + filePath2);
